...
<form name="updatePurchase" method="post"	action="/purchase/updatePurchase?tranNo=${vo.tranNo}">
	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20">
				<option value="1" ${! empty vo.paymentOption && vo.paymentOption==1? "selected":""}>현금구매</option>
				<option value="2" ${! empty vo.paymentOption && vo.paymentOption==2? "selected":""}>신용구매</option>
			</select>
		</td>
	</tr>
	<tr>
