...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<c:if test="${! empty vo.paymentOption && vo.paymentOption==1}">
				현금구매
			</c:if>
			<c:if test="${! empty vo.paymentOption && vo.paymentOption==2}">
				신용결제
			</c:if>
		</td>
	</tr>
	...
	<tr>
		...
		<td align="right">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<c:if test="${vo.tranCode==001}">
						<td width="17" height="23">
							<img src="/images/ct_btnbg01.gif" width="17" height="23"/>
						</td>
						<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
							<a href="/purchase/updatePurchaseView?tranNo=${vo.tranNo}">수정</a>
						</td>
						...
						<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
							<a href="/purchase/updateTranCode?tranNo=${vo.tranNo}&tranCode=999">구매취소</a>
						</td>
						<td width="14" height="23">
							<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
						</td>
